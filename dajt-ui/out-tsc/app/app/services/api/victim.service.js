...
var VictimService = /** @class */ (function () {
     ...
     */
    VictimService.prototype.getVictims = function (name, page, size) {
        ...
        var vicitmListSubject = new Subject(); // Will use this subject to emit data that we want
